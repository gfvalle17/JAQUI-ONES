...
class GestionController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        ->with('mensaje', 'La gestiòn se ha creado correctamente.')
        ->with('icono','success');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $gestion->save();
        return redirect()->route('admin.gestiones.index')
        ->with('mensaje', 'La gestiòn se ha actualizado correctamente.')
        ->with('icono','success');
    }
    ...
    public function destroy($id)
    {
        ...
        $gestion->delete();
        return redirect()->route('admin.gestiones.index')
        ->with('mensaje', 'La gestiòn se ha eliminado correctamente.')
        ->with('icono','success');
