...
@section('content_header')
    <h1>Creaciòn de una nueva formación del personal</h1>
    <hr>
@stop
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control" name="titulo" id="titulo" value="{{ old('titulo') }}" placeholder="Ingrese el título...">
                                            </div>
                                            @error('titulo')
                                                <small style="color: red">{{ $message }}</small>
                                            @enderror
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control" name="institucion" id="institucion" value="{{ old('institucion') }}" placeholder="Ingrese la institución...">
                                            </div>
                                            @error('institucion')
                                                <small style="color: red">{{ $message }}</small>
                                            @enderror
